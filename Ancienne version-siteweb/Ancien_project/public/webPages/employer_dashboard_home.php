...
<?php include '../../phpLogic/connection.php';?>
  ...
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title">Nombre total de stagiaires créés</h5>
        <h4 class="card-text text-primary"><?php echo $interns; ?></h4>
        <div onclick="loadDoc('content','public/webPages/created_interns.php')" class="btn btn-primary">Voir les stages</div>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="card">
      <div class="card-body">
        ...
        <div onclick="loadDoc('content','public/webPages/employer_dashboard_applicants.php')" class="btn btn-primary">Voir les candidats</div>
      </div>
    </div>
  </div>
</div>
