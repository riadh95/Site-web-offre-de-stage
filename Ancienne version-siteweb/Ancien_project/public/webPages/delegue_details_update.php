...
<div class="container body">
  <form class="form-signin" method="post" action="phpLogic/update.php?user=delegue">
    ...
    <input type="email" name="email" value="<?php echo $row['email_id']; ?>" id="inputEmail" class="form-control-plaintext rw" placeholder="name@viacesi.fr" required readonly autofocus>
